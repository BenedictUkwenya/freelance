...
import { AtSignIcon, LockIcon, UserIcon, AlertCircleIcon } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="password" name="password" type="password" autoComplete="current-password" required value={password} onChange={e => setPassword(e.target.value)} onBlur={() => handleBlur('password')} className={`appearance-none relative block w-full px-3 py-2 pl-10 border ${touched.password && password.length < 6 ? 'border-red-500 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'} placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white dark:bg-gray-700 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm transition-colors duration-200`} placeholder="Password" />
                </div>
                {touched.password && password.length < 6 && <p className="mt-1 text-xs text-red-600 dark:text-red-400">
